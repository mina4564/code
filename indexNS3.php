...
<style>
    ...
    .page:last-child {
    page-break-after: auto !important; /* 確保最後一頁不會強制換頁 */
    page-break-inside: auto !important; /* 避免頁面內部換頁 */
}
    #board button {
        width: 130px;
        margin: 10px 20px;
    ...
    top: 0;
    width: 35px;
    height: 100%; /* 高度設定為 100%，讓它根據頁面自動適應 */
    background: linear-gradient(#00AB95, #009F91, #007F7A);
}
.page {
    position: relative;
}
...
.left-bar {
    ...
    @media print {
        ...
        .left-bar {
        height: 100%; /* 確保在列印時，綠色邊條的高度也會自動適應頁面 */
    }

        body {
            -webkit-print-color-adjust: exact;
            background-image: url("../../assets/img/backgroundimage7.png") !important;
            background-size: cover !important;
            background-position: center !important;
            background-attachment: fixed !important;
            height: auto; /* 將高度設為自動以適應內容 */
            page-break-inside: avoid; /* 避免頁面內部換頁 */
            margin: 0;
        }
        ...
        .page {
            ...
            /* page-break-after: always; */
            page-break-inside: avoid;
            page-break-after: avoid; /* 避免不必要的換頁 */
            position: relative;
 ...
 /* 確保頁面內部不會斷開 */
    ...
    .page:last-child {
        page-break-after: auto !important; /* 最後一頁不進行換頁 */
...
<body>
            ...
            <div class="page">
                ...
                <div class="row  justify-content-end">
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4" style="margin-right:7rem">
                        <h4 class="" style="text-align:right;font-size:20px;"><?php if ($season != null) {
                                                                                    echo "季度 ";
                                                                                } ?><span style="font-size: 23px;"><?php
                                                                                                                                                        if ($season == 1) {
                                                                                                                                                            echo "➊➁➂➃";
                                                                                                                                                        }
                                                                                                                                                        if ($season == 2) {
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="font-size: 23px">
                        <ul style="padding-left: 17%">
                            ...
                            <li class="libefore">
                                ...
                                <!--                            <font color="black">--><?php //echo "$Serino"; 
                                                                                        ?><!-- / <span id="Serino"></span></font>-->
                            </li>
                            <li class="libefore">
    ...
    // 1. 選擇所有的 td, th 和 span 元素並檢查其內容
    var elements = document.querySelectorAll('td, th, span');
    elements.forEach(function(el) {
        var text = el.textContent.trim(); // 先 trim 一次，減少重複調用
        if (text === '--' || text === '【--】') {
            el.style.color = 'red'; // 將符合條件的元素文字設為紅色
        }
    });

    // 2. 檢查每個 .page 元素，如果內容超過頁面高度，避免頁面斷開
